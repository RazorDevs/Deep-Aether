...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("deep_aether", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_fin = body.addOrReplaceChild("right_fin",
				CubeListBuilder.create().texOffs(24, 1).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition fin_back = partdefinition.addOrReplaceChild("fin_back",
		...
		PartDefinition tail_sub_0 = tail.addOrReplaceChild("tail_sub_0",
				CubeListBuilder.create().texOffs(22, 3).mirror().addBox(0.0F, -4.0F, 9.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
