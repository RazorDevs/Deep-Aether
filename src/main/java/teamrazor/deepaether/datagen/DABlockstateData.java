...
public class DABlockstateData extends AetherBlockStateProvider {
    ...
    public void registerStatesAndModels() {
        ...
        this.crossBlock(DABlocks.GLOSSOM_GRASS.get());
        this.crossBlock(DABlocks.GLOSSOM_ROOTS.get());
        this.pottedPlantFix(DABlocks.POTTED_GLOSSOM_GRASS.get(), DABlocks.GLOSSOM_GRASS.get());
        this.pottedPlantFix(DABlocks.POTTED_GLOSSOM_ROOTS.get(), DABlocks.GLOSSOM_ROOTS.get());
        ...
        this.block(DABlocks.POLISHED_HOLYSTONE.get());
        this.stairs((StairBlock) DABlocks.POLISHED_HOLYSTONE_STAIRS.get(), DABlocks.POLISHED_HOLYSTONE.get());
        this.slab((SlabBlock) DABlocks.POLISHED_HOLYSTONE_SLAB.get(), DABlocks.POLISHED_HOLYSTONE.get());
        this.wallBlock((WallBlock) DABlocks.POLISHED_HOLYSTONE_WALL.get(), DABlocks.POLISHED_HOLYSTONE.get());

        this.block(DABlocks.LARGE_HOLYSTONE_BRICKS.get());
        this.stairs((StairBlock) DABlocks.LARGE_HOLYSTONE_BRICK_STAIRS.get(), DABlocks.LARGE_HOLYSTONE_BRICKS.get());
        this.slab((SlabBlock) DABlocks.LARGE_HOLYSTONE_BRICK_SLAB.get(), DABlocks.LARGE_HOLYSTONE_BRICKS.get());
        this.wallBlock((WallBlock) DABlocks.LARGE_HOLYSTONE_BRICK_WALL.get(), DABlocks.LARGE_HOLYSTONE_BRICKS.get());
    ...
    private void makeLogWalls() {
        ...
        this.logWallBlock(DABlocks.HOLYROOT_LOG_WALL.get(), DABlocks.SUNROOT_LOG.get(), DeepAetherMod.MODID, true, postBig, postShort, postTall, side, sideAlt, sideTall, sideTallAlt, sideShort, sideAltShort, sideTallShort, sideTallAltShort);
        this.logWallBlock(DABlocks.STRIPPED_HOLYROOT_LOG_WALL.get(), DABlocks.STRIPPED_SUNROOT_LOG.get(), DeepAetherMod.MODID, true, postBig, postShort, postTall, side, sideAlt, sideTall, sideTallAlt, sideShort, sideAltShort, sideTallShort, sideTallAltShort);
    }
    ...
    public void logWallBlock(WallBlock block, Block baseBlock, String modid, boolean postUsesTop, ModelFile postBig, ModelFile postShort, ModelFile postTall, ModelFile side, ModelFile sideAlt, ModelFile sideTall, ModelFile sideTallAlt, ModelFile sideShort, ModelFile sideAltShort, ModelFile sideTallShort, ModelFile sideTallAltShort) {
        this.logWallBlockInternal(block, this.name(block), new ResourceLocation(modid, "block/" + this.name(baseBlock)), postUsesTop, postBig, postShort, postTall, side, sideAlt, sideTall, sideTallAlt, sideShort, sideAltShort, sideTallShort, sideTallAltShort);
    }
