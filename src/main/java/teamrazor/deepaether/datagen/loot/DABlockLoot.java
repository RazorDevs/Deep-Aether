...
public class DABlockLoot extends AetherBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.dropSelf(DABlocks.AGATE_ORE.get());
        this.dropSelf(DABlocks.HIGHSTONE_AGATE_ORE.get());

        this.dropSelf(DABlocks.ADIBIUM_BLOCK.get());
        this.dropSelf(DABlocks.ADIBIUM_ORE.get());
        this.dropSelf(DABlocks.HIGHSTONE_ADIBIUM_ORE.get());

        this.dropSelf(DABlocks.PURPITE_BLOCK.get());
        this.dropSelf(DABlocks.RAW_PURPITE_BLOCK.get());
        this.dropSelf(DABlocks.PURPITE_ORE.get());
        this.dropSelf(DABlocks.HIGHSTONE_PURPITE_ORE.get());
        ...
        this.dropSelf(DABlocks.POLISHED_HOLYSTONE.get());
        this.dropSelf(DABlocks.POLISHED_HOLYSTONE_SLAB.get());
        this.dropSelf(DABlocks.POLISHED_HOLYSTONE_STAIRS.get());
        this.dropSelf(DABlocks.POLISHED_HOLYSTONE_WALL.get());

        this.dropSelf(DABlocks.LARGE_HOLYSTONE_BRICKS.get());
        this.dropSelf(DABlocks.LARGE_HOLYSTONE_BRICK_SLAB.get());
        this.dropSelf(DABlocks.LARGE_HOLYSTONE_BRICK_STAIRS.get());
        this.dropSelf(DABlocks.LARGE_HOLYSTONE_BRICK_WALL.get());
