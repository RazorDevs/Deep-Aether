...
public class DAItemModelData extends AetherItemModelProvider {
    ...
    public void bowItem(Item item) {
        ...
        this.withExistingParent(this.itemName(item), this.mcLoc("item/bow"))
                ...
                //Special
                .override().predicate(new ResourceLocation("pulling"), 1).predicate(DeepAether.getResource( "enchanted"), 1.0F)
                .model(this.getExistingFile(this.modLoc("item/" + this.itemName(item) + "_pulling_0_special"))).end()
                .override().predicate(new ResourceLocation("pulling"), 1).predicate(new ResourceLocation("pull"), 0.65F).predicate(DeepAether.getResource( "enchanted"), 1.0F)
                .model(this.getExistingFile(this.modLoc("item/" + this.itemName(item) + "_pulling_1_special"))).end()
                .override().predicate(new ResourceLocation("pulling"), 1).predicate(new ResourceLocation("pull"), 0.9F).predicate(DeepAether.getResource( "enchanted"), 1.0F)
