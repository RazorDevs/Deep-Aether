...
public class DAPlacementModifiers {
    ...
    public static final PlacementModifierType<ImprovedRarityFilter> IMPROVED_RARITY_FILTER = register(DeepAether.getResource( "dungeon_blacklist_filter"), ImprovedRarityFilter.CODEC);
