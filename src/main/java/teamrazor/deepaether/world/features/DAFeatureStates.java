...
public class DAFeatureStates {
    ...
    public static final BlockState HOLYROOT_LOG = DABlocks.HOLYROOT_LOG.get().defaultBlockState().setValue(AetherBlockStateProperties.DOUBLE_DROPS, true);
    ...
    public static final BlockState HOLYROOT_LEAVES = DABlocks.HOLYROOT_LEAVES.get().defaultBlockState().setValue(AetherBlockStateProperties.DOUBLE_DROPS, true);
