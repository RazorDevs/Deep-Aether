...
public class DAFoliagePlacers {
        ...
        public static final DeferredHolder<FoliagePlacerType<?>,FoliagePlacerType<SunrootFoliagePlacer>> SUNROOT_FOLIAGE_PLACER = FOLIAGE_PLACERS.register("sunroot_foliage_placer", () -> new FoliagePlacerType<>(SunrootFoliagePlacer.CODEC));
}