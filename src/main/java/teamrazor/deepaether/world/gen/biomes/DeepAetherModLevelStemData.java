...
import com.gildedgames.aether.data.generators.AetherLevelStemData;
...
public class DeepAetherModLevelStemData {

    public static DataProvider create(PackOutput output, ExistingFileHelper helper) {
        HolderLookup.Provider aetherRegistry = DeepAetherModWorldGenData.createLookup();
        ...
        return new JsonCodecProvider<>(output, helper, DeepAetherMod.MODID, registryOps, PackType.SERVER_DATA, registryFolder, LevelStem.CODEC, map);
    }
}
