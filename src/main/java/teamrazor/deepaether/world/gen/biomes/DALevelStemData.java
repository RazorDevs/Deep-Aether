...
public class DALevelStemData {

    public static DataProvider create(PackOutput output, ExistingFileHelper helper) {
        HolderLookup.Provider aetherRegistry = DAWorldGenData.createLookup();
        ...
        BiomeSource source = DABiomes.buildDeepAetherModBiomeSource(biomes);
