...
public class DeepAetherBiomeBuilder extends AetherBiomeBuilders {
    public static BiomeSource buildDeepAetherBiomeSource(Registry<Biome> registry) {
        ...
        return new MultiNoiseBiomeSource(new Climate.ParameterList<>(List.of(
                Pair.of(new Climate.ParameterPoint(FULL_RANGE, FULL_RANGE, FULL_RANGE, FULL_RANGE, FULL_RANGE, Climate.Parameter.span(1.0F, 2.0F), 0),
                        Holder.Reference.createStandAlone(registry, DeepAetherModBiomes.VIRULENT_FOREST))

        )));
    }

    public static Biome virulentForest() {
