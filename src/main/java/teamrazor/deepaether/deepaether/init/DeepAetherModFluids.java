...
public class DeepAetherModFluids {
    ...
    public static final RegistryObject<FlowingFluid> POISON_FLUID = REGISTRY.register("poison_fluid", () -> new ForgeFlowingFluid.Source(teamrazor.deepaether.init.DeepAetherModFluids.POISON_PROPERTIES));

    public static final RegistryObject<FlowingFluid> POISON_FLOWING = REGISTRY.register("poison_flowing", () -> new ForgeFlowingFluid.Flowing(teamrazor.deepaether.init.DeepAetherModFluids.POISON_PROPERTIES));
