package teamrazor.deepaether.deepaether.world;/*package teamrazor.deepaether.world;
...
public abstract class DeepAetherModWorldProvider extends AetherWorldProvider {

    public DeepAetherModWorldProvider(DataGenerator generator) {
        super(generator);
    }
