...
public record DeepAetherModOreBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return DeepAetherModBiomeModifiers.ORE_MODIFIER.get();
    }
}