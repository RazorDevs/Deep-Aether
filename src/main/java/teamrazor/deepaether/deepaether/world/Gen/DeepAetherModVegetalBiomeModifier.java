...
public record DeepAetherModVegetalBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return DeepAetherModBiomeModifiers.VEGETAL_MODIFIER.get();
    }
}