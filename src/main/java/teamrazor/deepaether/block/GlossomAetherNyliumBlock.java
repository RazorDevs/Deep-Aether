...
import teamrazor.deepaether.world.features.DAPlacedFeatures;

import java.util.List;
import java.util.Optional;

public class GlossomAetherNyliumBlock extends AetherGrassBlock {
    public GlossomAetherNyliumBlock(Properties properties) {
        super(properties);
    }
    ...
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        ...
        BlockState blockstate = DABlocks.GLOSSOM_GRASS.get().defaultBlockState();
        Optional<Holder.Reference<PlacedFeature>> optional = p_221270_.registryAccess().registryOrThrow(Registries.PLACED_FEATURE).getHolder(DAPlacedFeatures.GLOSSOM_GRASS_BONEMEAL);
    ...
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        BlockPos blockpos = p_221272_.above();
        BlockState blockstate = DABlocks.GLOSSOM_ROOTS.get().defaultBlockState();
        Optional<Holder.Reference<PlacedFeature>> optional = p_221270_.registryAccess().registryOrThrow(Registries.PLACED_FEATURE).getHolder(DAPlacedFeatures.GLOSSOM_GRASS_BONEMEAL);
