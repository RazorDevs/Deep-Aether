...
public class DAJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(PoisonRecipeCategory.RECIPE_TYPE, rm.getAllRecipesFor(DARecipeTypes.POISON_RECIPE.get()));
        registration.addRecipes(CombinerRecipeCategory.RECIPE_TYPE, rm.getAllRecipesFor(DARecipeTypes.COMBINING.get()));
