...
public class DABlocks {
	...
	// WOOD
	public static final RegistryObject<Block> ROSE_WOOD = registerBlock("rose_wood", () -> new DALogBlock(Block.Properties.copy(Blocks.OAK_WOOD)));
	public static final RegistryObject<Block> ROSE_LOG = registerBlock("rose_log", () -> new DALogBlock(Block.Properties.copy(Blocks.OAK_LOG)));
	...
	public static final RegistryObject<Block> STRIPPED_ROSE_WOOD = registerBlock("stripped_rose_wood", () -> new DALogBlock(Block.Properties.copy(Blocks.OAK_WOOD)));
	public static final RegistryObject<Block> STRIPPED_ROSE_LOG = registerBlock("stripped_rose_log", () -> new DALogBlock(Block.Properties.copy(Blocks.OAK_LOG)));
	...
	public static final RegistryObject<Block> ROSE_STAIRS = registerBlock("rose_stairs", () -> new StairBlock(() -> DABlocks.ROSE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_WOOD)));
	public static final RegistryObject<Block> ROSE_SLAB = registerBlock("rose_slab", () -> new DASlabBlock());
	...
	public static final RegistryObject<Block> ROSE_PRESSURE_PLATE = registerBlock("rose_pressure_plate", () -> new DAPressurePlateBlock());
	...
	public static final RegistryObject<Block> ROSE_LEAVES = registerBlock("rose_leaves", () -> new DALeavesBlock());
	...
	public static final RegistryObject<Block> ROSEROOT_WALL_SIGN = BLOCKS.register("rose_wall_sign", () -> new DAWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), DAWoodTypes.ROSEROOT));
	public static final RegistryObject<Block> ROSEROOT_SIGN = BLOCKS.register("rose_sign", () -> new DASignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), DAWoodTypes.ROSEROOT));
	...
	public static final RegistryObject<Block> YAGROOT_STAIRS = registerBlock("yagroot_stairs", () -> new StairBlock(() -> DABlocks.ROSE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_WOOD)));
	public static final RegistryObject<Block> YAGROOT_SLAB = registerBlock("yagroot_slab", () -> new DASlabBlock());
	...
	public static final RegistryObject<Block> YAGROOT_PRESSURE_PLATE = registerBlock("yagroot_pressure_plate", () -> new DAPressurePlateBlock());
	...
	public static final RegistryObject<Block> YAGROOT_LEAVES = registerBlock("yagroot_leaves", () -> new DAEffectBlock());
	...
	public static final RegistryObject<Block> CRUDEROOT_SLAB = registerBlock("cruderoot_slab", () -> new DASlabBlock());
	...
	public static final RegistryObject<Block> CRUDEROOT_PRESSURE_PLATE = registerBlock("cruderoot_pressure_plate", () -> new DAPressurePlateBlock());
	...
	public static final RegistryObject<Block> CRUDEROOT_LEAVES = registerBlock("cruderoot_leaves", () -> new DALeavesBlock());
	...
	public static final RegistryObject<Block> GREOTITE = registerBlock("greotite", () -> new AetherDoubleDropBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
	...
	public static final RegistryObject<Block> GREOTITE_STAIRS = registerBlock("greotite_stairs", () -> new StairBlock(() -> DABlocks.GREOTITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> POLISHED_GREOTITE_STAIRS = registerBlock("polished_greotite_stairs", () -> new StairBlock(() -> DABlocks.POLISHED_GREOTITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> JARINITE = registerBlock("jarinite", () -> new AetherDoubleDropBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
	...
	public static final RegistryObject<Block> JARINITE_STAIRS = registerBlock("jarinite_stairs", () -> new StairBlock(() -> DABlocks.JARINITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> POLISHED_JARINITE_STAIRS = registerBlock("polished_jarinite_stairs", () -> new StairBlock(() -> DABlocks.POLISHED_JARINITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> YALLESITE = registerBlock("yallesite", () -> new AetherDoubleDropBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
	...
	public static final RegistryObject<Block> YALLESITE_STAIRS = registerBlock("yallesite_stairs", () -> new StairBlock(() -> DABlocks.YALLESITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> POLISHED_YALLESITE_STAIRS = registerBlock("polished_yallesite_stairs", () -> new StairBlock(() -> DABlocks.POLISHED_YALLESITE.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(2.0F, 6.0F).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> DARKERITE = registerBlock("darkerite", () -> new AetherDoubleDropBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
