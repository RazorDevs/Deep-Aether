...
public class DeepAetherKeys {
    ...
    public final static KeyMapping TOGGLE_SKYJADE_TRANSPARENCY = new ToggleKeyMapping("key.deep_aether.toggle_skyjade_transparency", GLFW.GLFW_KEY_V, "key.aether.category", () -> true);
