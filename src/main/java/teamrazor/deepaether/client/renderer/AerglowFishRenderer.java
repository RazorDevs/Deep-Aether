...
@OnlyIn(Dist.CLIENT)
public class AerglowFishRenderer extends MobRenderer<AerglowFish, AerglowFishModel<AerglowFish>> {
	...
	public AerglowFishRenderer(EntityRendererProvider.Context p_174364_) {
		super(p_174364_, new AerglowFishModel<>(p_174364_.bakeLayer(DAModelLayers.AERGLOW_FISH)), 0.4F);
	}
