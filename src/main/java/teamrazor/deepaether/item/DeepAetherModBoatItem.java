...
public class DeepAetherModBoatItem extends BoatItem {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);

    private final DeepAetherModBoat.Type type;
    private final boolean hasChest;

    public DeepAetherModBoatItem(boolean p_220013_, DeepAetherModBoat.Type p_220014_, Properties p_220015_) {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                DeepAetherModBoat boat = this.getBoat(p_40622_, hitresult);
                boat.setDeepAetherModBoatType(this.type);
    ...
    private DeepAetherModBoat getBoat(Level p_220017_, HitResult p_220018_) {
        return this.hasChest ? new DeepAetherModChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new DeepAetherModBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
    }
}
