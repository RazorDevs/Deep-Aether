...
public class DAWallBlock extends WallBlock {
    ...
    public @Nullable BlockState getToolModifiedState(BlockState state, UseOnContext context, ItemAbility itemAbility, boolean simulate) {
        if(context.getItemInHand().getItem() instanceof AxeItem) {
            if(state.is(DABlocks.ROSEROOT_WOOD_WALL.get())) {
                return DABlocks.STRIPPED_ROSEROOT_WOOD_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.ROSEROOT_LOG_WALL.get())) {
                return DABlocks.STRIPPED_ROSEROOT_LOG_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.YAGROOT_WOOD_WALL.get())) {
                return DABlocks.STRIPPED_YAGROOT_WOOD_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.YAGROOT_LOG_WALL.get())) {
                return DABlocks.STRIPPED_YAGROOT_LOG_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.CRUDEROOT_WOOD_WALL.get())) {
                return DABlocks.STRIPPED_CRUDEROOT_WOOD_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.CRUDEROOT_LOG_WALL.get())) {
                return DABlocks.STRIPPED_CRUDEROOT_LOG_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.CONBERRY_WOOD_WALL.get())) {
                return DABlocks.STRIPPED_CONBERRY_WOOD_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.CONBERRY_LOG_WALL.get())) {
                return DABlocks.STRIPPED_CONBERRY_LOG_WALL.get().defaultBlockState();
            }
            if(state.is(DABlocks.SUNROOT_WOOD_WALL.get())) {
                return DABlocks.STRIPPED_SUNROOT_WOOD_WALL.get().defaultBlockState();
            }
