...
import io.github.razordevs.deep_aether.world.feature.features.HolystoneSpikeFeature;
...
public class DAFeatures {
    ...
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> HOLYSTONE_SPIKE = FEATURES.register("holystone_spike", () -> new HolystoneSpikeFeature(NoneFeatureConfiguration.CODEC));
