...
public class YagrootRootPlacer extends RootPlacer {
    public static final MapCodec<YagrootRootPlacer> CODEC = RecordCodecBuilder.mapCodec((provider) -> rootPlacerParts(provider).and(MangroveRootPlacement.CODEC.fieldOf("yagroot_root_placer").forGetter((rootPlacer) -> rootPlacer.yagrootRootPlacement)).apply(provider, YagrootRootPlacer::new));
