...
public class DAFeatureStates {
    ...
    public static final BlockState AERCLOUD_LEAVES = DABlocks.AERCLOUD_ROOTS.get().defaultBlockState().setValue(AetherBlockStateProperties.DOUBLE_DROPS, true);
    ...
    public static final BlockState AETHER_MOSS = DABlocks.AETHER_MOSS_BLOCK.get().defaultBlockState();
